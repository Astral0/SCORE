...
> **Document de Reference Technique** - Architecture, Database, API, Securite, Deploiement
>
> Ce document consolide toutes les specifications techniques du projet SCORE.
> Pour les specifications fonctionnelles, voir [PRD-functional.md](PRD-functional.md).
>
